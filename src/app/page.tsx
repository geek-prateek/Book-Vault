...
export default async function Home() {
  ...
  return (
    <main className="max-w-6xl mx-auto p-3 md:p-4 lg:p-8 min-h-screen">
      ...
      <section className="mb-12 md:mb-16">
        <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-blue-400">Focus Mode</h2>
      ...
      <section>
        <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6 text-green-400">Your Library</h2>
